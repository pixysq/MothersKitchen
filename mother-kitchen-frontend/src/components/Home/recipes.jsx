...
const recipes = () => {
  return (
    <div
      ...
      style={{ backgroundColor: '#7B1238', borderWidth: '10px' }}
    >
      <div className="rounded-2xl p-4" style={{ border: '5px solid white' }}>
        ...
        <div className="flex flex-wrap justify-center">
          {recipesData.map((data, index) => (
            <div key={index} className="mb-6 flex w-full flex-col items-center gap-2 justify-evenly sm:w-1/2 lg:w-1/4">
              <img
                src={data.photo}
                alt="photo"
        ...
        <div className="flex items-center justify-center ">
          <Link
            to="/recipes"
            className="flex w-fit items-center justify-center rounded-full border-b-8 border-l-2 border-r-8 border-t-2 border-black p-3 text-center font-gluten text-xl sm:text-2xl md:text-3xl"
